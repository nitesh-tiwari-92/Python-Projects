...
from User_Input import mul_input, single_input, double_input, continuation # Calling function to get the Input from User via user_input() function from User_Input.py file
import logging
